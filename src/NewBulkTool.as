...
<<<<<<< HEAD
	...
	params.genes_send=zerostateavalue;
...
public function httpResults(event:ResultEvent):void {
	var result:Object = event.result;
	navigateToURL(new URLRequest("http://popgenie.org/content/bulk-tools-4?agi="+searchText+"&type="+typeText), "_parent")
